...
config :speak, SpeakWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "UCKfbbhtHloILFptdOtOzzhDLG35EIE9un1O2cE5bKL1Nm78ZQ0W6teLQr7WZM/Z",
  watchers: [
...
config :speak, SpeakWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/speak_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :speak, dev_routes: true
