defmodule SpeakWeb.CoreComponents do
  @moduledoc """
  ...
  def simple_form(assigns) do
    ~H"""
    <.form :let={f} for={@for} as={@as} {@rest} multipart={@multipart}>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SpeakWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SpeakWeb.Gettext, "errors", msg, opts)
    end
  end
